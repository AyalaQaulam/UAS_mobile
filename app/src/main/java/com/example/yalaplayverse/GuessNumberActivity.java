...
public class GuessNumberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        guess.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(chances == 0){
                    Toast.makeText(GuessNumberActivity.this, "No Remaining Chances", Toast.LENGTH_SHORT).show();
                }
                ...
                if(chances > 0) {
                    ...
                    if (randomNumber == number) {
                        ...
                        imageView.setImageResource(R.drawable.repurple);
    ...
    public void onBackPressed(){
        new AlertDialog.Builder(GuessNumberActivity.this)
