...
import com.example.yalaplayverse.databinding.ActivitySnakeGameBinding
...
class SnakeGameActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lateinit var binding: ActivitySnakeGameBinding
        ...
        newgame.setOnClickListener {
            ...
            meat.setImageResource(R.drawable.fruit)
